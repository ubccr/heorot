...
export async function dell_clearSel(uri: string, auth: Auth) {
...
export async function sm_clearSel(uri: string, auth: Auth) {
...
export async function hpe_clearSel(uri: string, auth: Auth) {
